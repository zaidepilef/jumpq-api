...
// GET
Schedules.get('/', (_required, response) => {


    
    var query = "SELECT FROM company com,schedule sch ORDER BY `branch_id` DESC";
...
// GET LINK MAP
Schedules.get('/link/:id', (req, response) => {
    const { id } = req.params;
...
// DELETE
Schedules.delete('/:id', (req, response) => {
